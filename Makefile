...
EXTENSION_FLAGS=-DDUCKDB_OOT_EXTENSION_NAMES="some_function" -DDUCKDB_OOT_EXTENSION_SOME_FUNCTION_PATH="$(PROJ_DIR)" -DDUCKDB_OOT_EXTENSION_SOME_FUNCTION_SHOULD_LINK="TRUE" -DDUCKDB_OOT_EXTENSION_SOME_FUNCTION_INCLUDE_PATH="$(PROJ_DIR)src/include"
